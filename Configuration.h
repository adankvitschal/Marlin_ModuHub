...
#define STRING_CONFIG_H_AUTHOR "(Cesar Spanholi, ModuHub)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MH 3Dprinter"
...
// Prusa i3d 4 ohms hotend at 12v
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 853.33 } // 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 120, 7700 }
...
#define NUM_SERVOS 1 // É necessario denifinir o numero de servo motor que possui para homing do eixo Z.
...
//#define MESH_BED_LEVELING    // Enable mesh bed leveling.
  ...
  #define MESH_HOME_SEARCH_Z 0.5 // Z after Home, bed somewhere below but above 0.0.
...
#define Z_SAFE_HOMING  //Permite o eixo Z retornar a posição correta do Autohome, no centro da impressora.
